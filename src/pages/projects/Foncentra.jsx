            ...
            <div className="space-y-6 mb-8">
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border-l-4 border-[#609966]">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  <strong className="text-[#609966]">Solution:</strong> Implemented lazy initialization
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border-l-4 border-[#609966]">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  <strong className="text-[#609966]">Solution:</strong> Developed a smart taxonomy system
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border-l-4 border-[#609966]">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  <strong className="text-[#609966]">Solution:</strong> Implemented time-limited download
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border-l-4 border-[#609966]">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  <strong className="text-[#609966]">Solution:</strong> Developed a custom WordPress
          ...
          <div className={`transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white dark:bg-gray-800 rounded-xl p-8 border border-green-200 dark:border-green-800 text-center">
                <div className="text-4xl font-bold text-[#609966] mb-2">85%</div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-8 border border-green-200 dark:border-green-800 text-center">
                <div className="text-4xl font-bold text-[#609966] mb-2">4.2min</div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-8 border border-green-200 dark:border-green-800 text-center">
                <div className="text-4xl font-bold text-[#609966] mb-2">500+</div>
